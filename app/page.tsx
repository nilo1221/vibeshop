          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-10 max-w-5xl mx-auto">
              <div className="glass p-8 rounded-2xl border border-[#96bf48]/20 hover:border-[#96bf48]/40 transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: '0.6s' }}>
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-lg">{t.creativeAINames}</h3>
              ...
              <div className="glass p-8 rounded-2xl border border-[#96bf48]/20 hover:border-[#96bf48]/40 transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: '0.8s' }}>
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-lg">{t.nicheSpecific}</h3>
              ...
              <div className="glass p-8 rounded-2xl border border-[#96bf48]/20 hover:border-[#96bf48]/40 transition-all hover:scale-105 animate-fade-in" style={{ animationDelay: '1s' }}>
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2 text-lg">{t.instantResults}</h3>
          ...
          <div className="glass p-12 rounded-3xl shadow-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">{t.whatYouGet}</h3>
              ...
              <div className="text-center">
                <div className="text-6xl mb-6">🤝</div>
                <h3 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">{t.howWeHelp}</h3>
                <ul className="space-y-4 text-left">
                  <li className="flex items-start gap-3">
                    <span className="text-[#96bf48] text-xl">✓</span>
          ...
          <div className="glass p-12 rounded-3xl shadow-2xl">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">{t.chooseYourName}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">{t.checkDomainStep}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">{t.openShopify}</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2">{t.launchAndGrow}</h3>
